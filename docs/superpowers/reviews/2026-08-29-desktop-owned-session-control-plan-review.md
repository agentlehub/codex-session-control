...
- Lifecycle deletion follows live-harness replacement and uses retained behavioral tests plus direct deletion evidence instead of permanent source-shape tests.
